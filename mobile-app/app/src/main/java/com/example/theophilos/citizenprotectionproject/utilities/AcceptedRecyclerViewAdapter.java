...
public class AcceptedRecyclerViewAdapter extends RecyclerView.Adapter<AcceptedRecyclerViewAdapter.ViewHolder>{
    ...
    public AcceptedRecyclerViewAdapter(ArrayList<String> iNames , ArrayList<String> iPriorities, ArrayList<String> iIds , Context cont ){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Intent intent = new Intent(context, AcceptedIncidentPreviewActivity.class);
